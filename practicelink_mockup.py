...
st.set_page_config(
    page_title="PracticeLink AI — Job Matching",
    page_icon="🏥",
    layout="wide",
...
<div class="topbar">
  ...
  <div>
    ...
    <p class="topbar-sub">AI-powered physician recruitment</p>
  </div>
  <div class="sf-badge">
...
steps = [
    ...
    ("#185FA5", "Step 2 — AI model", "Match engine", "Embedding similarity + preference scoring"),
...
with left:
    ...
    <div class="profile-card">
      <div style="display:flex;align-items:center;margin-bottom:10px">
        ...
        <div>
          <p class="profile-name">Dr. Rebecca Chen</p>
...
<div style="text-align:center;font-size:11px;color:#94A3B8;padding:1rem 0">
  PracticeLink AI Matching · JHU IT Consulting Lab · Week 5 Concept Demo
</div>
""", unsafe_allow_html=True)
